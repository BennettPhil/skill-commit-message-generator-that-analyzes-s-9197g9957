...
DEFAULT_TOPIC="A commit message generator that analyzes staged git changes and produces a conventional commit message. It should detect the type (feat, fix, refactor, etc.) and scope from the diff."
DEFAULT_CONTEXT=""
